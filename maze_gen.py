...
class Grid:
    ...
    def add_pattern(self) -> None:
        ...
        pattern_ft :list[list[int]]= [
                    ...
                    [0x2, 0xf, 0x8, 0x0, 0x2, 0xf, 0xf, 0xf, 0x8],
                    [0x2, 0xf, 0xc, 0x4, 0x0, 0x5, 0x7, 0xf, 0x8],
                    [0x2, 0xf, 0xf, 0xf, 0xa, 0xf, 0xf, 0xf, 0x8],
                    [0x0, 0x1, 0x3, 0xf, 0xa, 0xf, 0xd, 0x5, 0x0],
                    [0x0, 0x0, 0x2, 0xf, 0xa, 0xf, 0xf, 0xf, 0x8],
                    [0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0]
                ]
        ...
        for i in range(center_i - 3, center_i + 4):
            pj = 0
            for j in range(center_j - 4, center_j + 5):
